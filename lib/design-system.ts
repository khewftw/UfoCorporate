...
export const ds = {
  ...
  /** Строка «время чтения» */
  readingMeta: "flex items-center gap-2 text-xs font-medium text-[#9CA3AF]",
  ...
  pillLabel: "text-center text-[10px] font-medium leading-tight text-[#6B7280] md:text-xs",
  ...
  /** Кнопка Secondary (на тints / белом) */
  btnSecondary:
