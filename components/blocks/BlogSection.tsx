        ...
        {articles.map((post) => (
          ...
          >
            <div className="relative z-10 flex flex-col items-center p-6 pb-0 pt-0 text-center">
              ...
              <p
                className={`mt-3 max-w-[260px] text-base font-normal leading-relaxed ${post.descClass} line-clamp-3`}
              >
                {post.description}
              </p>
            </div>
            ...
            <div className="absolute bottom-6 left-1/2 z-20 -translate-x-1/2">
              <button
                type="button"
                className={`${ds.btnSecondaryTint} !border-0 !bg-white/70 !backdrop-blur-sm transition-all duration-300 hover:!scale-105 group-hover:!bg-[#FFDD2D] group-hover:!text-[#111827] group-hover:!shadow-[0_0_25px_rgba(255,221,45,0.6)]`}
              >
                Подробнее
              </button>
            </div>
